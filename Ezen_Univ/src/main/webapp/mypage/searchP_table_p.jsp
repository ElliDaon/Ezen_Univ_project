        ...
        <div class="contents">
            ...
            <div class="first_line" style="width: 800px;">
            	<form name="pnamefrm">
            		...
            		교수이름 <input type="text" id="p_name" name="p_name" onkeyup="enterkey()" style="width:120px;">&emsp;<button type="button" name="namebtn" id="namebtn" onclick="searchP()"><i class="fa fa-search" aria-hidden="true"></i></button>
            	</form>
            </div>
